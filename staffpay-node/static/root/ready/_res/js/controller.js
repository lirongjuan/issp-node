...
app.controller('businessCtrl', function ($scope,$state) {
    ...
    $scope.navCla=active?active:'examine';
    ...
    $scope.showsList = [
        {id:"1",item:"员工工资资金准备与支付",menuList:[{name1:"资金准备审核表",msg:'examine'},{name2:"等待付款",msg:'awaitpay'},{name3:"第一次工资记录",msg:'firstwage'}
          ,{name4:"已付款记录",msg:'paymentRecord'}],showIs:true},
