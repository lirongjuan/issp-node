var app = angular.module('basicInfo', [{
    files:[
        "root/emption/basicInfo/_res/js/service.js"
    ]
}]);
app.controller('basicInfoCtrl',function ($scope,$state) {
    ...
    $scope.edit = function(){
        if($scope.getId){
            $state.go('root.emption.basicInfo.edit[12]',{id:$scope.getId,page:$scope.page});
    ...
    $scope.delete = function(){
        if($scope.getId){
            $state.go('root.emption.basicInfo.list[12]',{id:$scope.getId,name:"delete",page:$scope.page});
