var app = angular.module('alleventList', ['ng-pagination','toastr']);
app.controller('alleventListCtrl',function($scope,alleventSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        alleventSer.listfather(pages).then(function(response){
    ...
    alleventSer.countfather().then(function(response){
        if(response.data.code==0){
