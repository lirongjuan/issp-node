var app = angular.module('basicinfoImport', ['toastr']);
app.controller('basicinfoimportCtrl', function($scope, basicinfoSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/contractprojectinfo/templateExport');
    };
    //删除文件
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/contractprojectinfo/importExcel',
                headers: {
