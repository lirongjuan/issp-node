...
app.controller('standardCtrl',function ($scope,$state) {
    ...
    $scope.edit = function(){
        if($scope.getId){
            $state.go('root.contract.standard.edit[12]',{id:$scope.getId,page:$scope.page});
    ...
    $scope.delete = function(){
        if($scope.getId){
            $state.go('root.contract.standard.list[12]',{id:$scope.getId,name:"delete",page:$scope.page});
