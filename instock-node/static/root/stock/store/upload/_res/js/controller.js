var app = angular.module('storeUpload', ['toastr']);
app.controller('storeUploadCtrl', function ($scope, storeSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/materialinstock/uploadFile',
                headers: {
