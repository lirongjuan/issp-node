var app = angular.module('carUpload', ['toastr']);
app.controller('carUploadCtrl', function ($scope, carSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/carrentalagreement/uploadFile',
                headers: {
