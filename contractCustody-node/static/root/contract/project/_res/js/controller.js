var app = angular.module('project', [{
    files:[
        "root/contract/project/_res/js/service.js"
    ]
}]);
app.controller('projectCtrl',function ($scope,$state) {
    ...
    $scope.edit = function(){
        if($scope.getId){
            $state.go('root.contract.project.edit[12]',{id:$scope.getId,page:$scope.page});
    ...
    $scope.delete = function(){
        if($scope.getId){
            $state.go('root.contract.project.list[12]',{id:$scope.getId,name:"delete",page:$scope.page});
    ...
    $scope.upload = function(){
        if($scope.getId){
            $state.go('root.contract.project.upload[12]',{id:$scope.getId,page:$scope.page});
    ...
    $scope.download = function(){
        if($scope.getId){
            $state.go('root.contract.project.view[12]',{id:$scope.getId,page:$scope.page});
