var app = angular.module('projectUpload', ['toastr']);
app.controller('projectUploadCtrl', function ($scope, projectSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/projectcontract/uploadFile',
                headers: {
