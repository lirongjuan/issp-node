var app = angular.module('houseUpload', ['toastr']);
app.controller('houseUploadCtrl', function ($scope, houseSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/housingcontract/uploadFile',
                headers: {
