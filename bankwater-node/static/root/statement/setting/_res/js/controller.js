...
app.controller('settingCtrl',function ($scope,$state) {
    ...
    $scope.edit = function(){
        if($scope.getId){
            $state.go('root.statement.setting.edit[12]',{id:$scope.getId,page:$scope.page});
