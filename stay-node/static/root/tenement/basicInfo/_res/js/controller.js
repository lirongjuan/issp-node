var app = angular.module('basicInfo', [{
    files:[
        "root/tenement/basicInfo/_res/js/service.js"
    ]
}]);
app.controller('basicInfoCtrl',function ($scope,$state) {
    ...
    $scope.edit = function(){
        if($scope.getId){
            $state.go('root.tenement.basicInfo.edit[12]',{id:$scope.getId,page:$scope.page});
    ...
    $scope.delete = function(){
        if($scope.getId){
            $state.go('root.tenement.basicInfo.list[12]',{id:$scope.getId,name:"delete",page:$scope.page});
    ...
    $scope.upload = function(){
        if($scope.getId){
            $state.go('root.tenement.basicInfo.upload[12]',{id:$scope.getId,page:$scope.page});
    ...
    $scope.download = function(){
        if($scope.getId){
            $state.go('root.tenement.basicInfo.view[12]',{id:$scope.getId,page:$scope.page});
