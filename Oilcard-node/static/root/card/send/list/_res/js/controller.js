var app = angular.module('sendList', ['ng-pagination','toastr']);
app.controller('sendListCtrl',function($scope,sendSer,toastr){
    ...
    $scope.Anfn =function(){
        if($scope.selectAn){
            ...
            sendSer.sendCollect($scope.selectAn).then(function(response){
                if(response.data.code == 0){
