var app = angular.module('summaryUpload', ['toastr']);
app.controller('summaryUploadCtrl', function ($scope, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/contractquotedata/uploadFile',
                headers: {
